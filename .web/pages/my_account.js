...
export function Textfield__input_060bcba6378d88931363d4d54b48e7a7 () {
  const state__login_state = useContext(StateContexts.state__login_state)



  return (
    <RadixThemesTextField.Input name={`postal_code`} placeholder={state__login_state.address.postal_code}/>
  )
}
...
export function Textfield__input_66995e7acb67943db2a06d69d51f9cd3 () {
  const state__login_state = useContext(StateContexts.state__login_state)



  return (
    <RadixThemesTextField.Input name={`autonomous_community`} placeholder={state__login_state.address.autonomous_community}/>
  )
}

export function Textfield__input_d7999e81900883256873797dd930ea0e () {
  const state__login_state = useContext(StateContexts.state__login_state)



  return (
    <RadixThemesTextField.Input name={`address`} placeholder={state__login_state.address.address}/>
  )
}

export function Textfield__input_fcc0bd02c8cbd10dffd3402bbc1ab44e () {
  const state__login_state = useContext(StateContexts.state__login_state)



  return (
    <RadixThemesTextField.Input value={state__login_state.user.email}/>
  )
}

export function Root_85fa4b7ac9a6098a784588042e115f3e () {
  const state__login_state = useContext(StateContexts.state__login_state)
  const [addEvents, connectErrors] = useContext(EventLoopContext);


  
    const handleSubmit_b8438374b426c3bea521d8fb92c8089b = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...{}}

        addEvents([Event("state.login_state.update_address", {form_data:form_data,address_id:state__login_state.address.id,user_id:state__login_state.user.id})])
  ...
  return (
    <RadixFormRoot className={`Root`} onSubmit={handleSubmit_b8438374b426c3bea521d8fb92c8089b}>
  <RadixThemesFlex direction={`column`} gap={`6`}>
  <RadixThemesFlex direction={`row`} gap={`9`}>
  <RadixThemesFlex direction={`column`} gap={`2`}>
  <RadixThemesText as={`p`}>
  {`Dirección: `}
</RadixThemesText>
  <Textfield__input_d7999e81900883256873797dd930ea0e/>
</RadixThemesFlex>
  <RadixThemesFlex direction={`column`} gap={`2`}>
  <RadixThemesText as={`p`}>
  {`Ciudad: `}
</RadixThemesText>
  <Textfield__input_1f744e5496001d7da0a2cc040f62bcf6/>
</RadixThemesFlex>
</RadixThemesFlex>
  <RadixThemesFlex direction={`row`} gap={`9`}>
  <RadixThemesFlex direction={`column`} gap={`2`}>
  ...
  <Textfield__input_66995e7acb67943db2a06d69d51f9cd3/>
</RadixThemesFlex>
  <RadixThemesFlex direction={`column`} gap={`2`}>
  <RadixThemesText as={`p`}>
  {`Código postal: `}
</RadixThemesText>
  <Textfield__input_060bcba6378d88931363d4d54b48e7a7/>
</RadixThemesFlex>
</RadixThemesFlex>
  <RadixThemesFlex direction={`column`}>
...
export function Textfield__input_1f744e5496001d7da0a2cc040f62bcf6 () {
  const state__login_state = useContext(StateContexts.state__login_state)



  return (
    <RadixThemesTextField.Input name={`city`} placeholder={state__login_state.address.city}/>
  )
}
...
export function Textfield__input_9efb05f2f3b7a3543f2a5d3341dae6f1 () {
  const state__login_state = useContext(StateContexts.state__login_state)



  return (
    <RadixThemesTextField.Input name={`phone_number`} placeholder={state__login_state.user.phone_number}/>
  )
}

export function Root_666216bfb0c54a59c90e2e3aa52989f1 () {
  const state__login_state = useContext(StateContexts.state__login_state)
  const [addEvents, connectErrors] = useContext(EventLoopContext);


  
    const handleSubmit_897ae8d53afdc70666e710c2943d62f2 = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...{}}

        addEvents([Event("state.login_state.update_user", {form_data:form_data,id:state__login_state.user.id})])
  ...
  return (
    <RadixFormRoot className={`Root`} onSubmit={handleSubmit_897ae8d53afdc70666e710c2943d62f2}>
  <RadixThemesFlex direction={`column`} gap={`6`}>
  <RadixThemesFlex direction={`row`} gap={`9`}>
  <RadixThemesFlex direction={`column`} gap={`2`}>
  <RadixThemesText as={`p`}>
  ...
  <Textfield__input_0e6574c807346fa45a7fe72957b9e8f0/>
</RadixThemesFlex>
  <RadixThemesFlex direction={`column`} gap={`2`}>
  <RadixThemesText as={`p`}>
  {`Apellidos: `}
</RadixThemesText>
  <Textfield__input_74cb977e023d09befa92faf903d7277b/>
</RadixThemesFlex>
</RadixThemesFlex>
  <RadixThemesFlex direction={`row`} gap={`9`}>
  <RadixThemesFlex direction={`column`} gap={`2`}>
  ...
  <Textfield__input_fcc0bd02c8cbd10dffd3402bbc1ab44e/>
</RadixThemesFlex>
  <RadixThemesFlex direction={`column`} gap={`2`}>
  <RadixThemesText as={`p`}>
  {`Contraseña: `}
</RadixThemesText>
  <Fragment_cfd80003c7defdfea8557d32b641ccae/>
</RadixThemesFlex>
</RadixThemesFlex>
  <RadixThemesFlex direction={`column`} gap={`2`}>
  <RadixThemesText as={`p`}>
  ...
  <Textfield__input_9efb05f2f3b7a3543f2a5d3341dae6f1/>
</RadixThemesFlex>
  <RadixThemesFlex direction={`column`}>
  <RadixThemesButton type={`submit`}>
  {`Guardar datos`}
...
export function Fragment_cfd80003c7defdfea8557d32b641ccae () {
  const state__login_state = useContext(StateContexts.state__login_state)
  ...
  return (
    <Fragment>
  {isTrue(((state__login_state.user.password) !== (""))) ? (
  <Fragment>
  <RadixThemesTextField.Input name={`password`} placeholder={`************`}/>
</Fragment>
) : (
  <Fragment>
...
export function Textfield__input_0e6574c807346fa45a7fe72957b9e8f0 () {
  const state__login_state = useContext(StateContexts.state__login_state)



  return (
    <RadixThemesTextField.Input name={`name`} placeholder={state__login_state.user.name}/>
  )
}
...
export function Textfield__input_74cb977e023d09befa92faf903d7277b () {
  const state__login_state = useContext(StateContexts.state__login_state)



  return (
    <RadixThemesTextField.Input name={`surname`} placeholder={state__login_state.user.surname}/>
  )
}
...
export default function Component() {
  ...
  <RadixThemesFlex align={`center`} css={{"width": "100%", "paddingTop": "0.8em", "paddingBottom": "1.5em"}} direction={`column`} gap={`2`}>
  <RadixThemesFlex align={`start`} direction={`column`} gap={`2`}>
  <RadixThemesHeading>
  {`Mi cuenta`}
</RadixThemesHeading>
</RadixThemesFlex>
  <RadixThemesFlex align={`start`} css={{"width": "60%"}} direction={`row`} gap={`2`}>
  <RadixThemesSeparator color={`mint`} css={{"height": "2px", "colorScheme": "mint"}} size={`4`}/>
</RadixThemesFlex>
  <RadixThemesFlex align={`center`} css={{"width": "60%"}} direction={`column`} gap={`5`}>
  <Root_666216bfb0c54a59c90e2e3aa52989f1/>
</RadixThemesFlex>
  <RadixThemesFlex align={`start`} css={{"width": "40%", "paddingTop": "2em", "paddingBottom": "1.5em"}} direction={`row`} gap={`2`}>
  <RadixThemesSeparator color={`mint`} css={{"height": "2px", "colorScheme": "mint"}} size={`4`}/>
</RadixThemesFlex>
  <RadixThemesFlex align={`center`} css={{"width": "60%"}} direction={`column`} gap={`5`}>
  <Root_85fa4b7ac9a6098a784588042e115f3e/>
</RadixThemesFlex>
</RadixThemesFlex>
